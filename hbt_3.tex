...
\draw[labelcol, fill=plotbg, rounded corners=3pt, line width=1pt]
    ($(DET2)+(-0.5,-0.35)$) rectangle ($(DET2)+(0.5, 0.35)$);
...
\draw[axiscol, line width=1.0pt, dashed]
    ($(HIST)+(0.0, 0.575)$)
    .. controls ($(HIST)+(1.0, 0.45)$) and ($(HIST)+(2.5, 0.20)$) ..
    ($(HIST)+(4.0, 0.01)$);
\node[text=axiscol, font=\scriptsize, left=1pt] at ($(HIST)+(4.0, 0.48)$) {uncorrelated};
...
\fill[histcol, opacity=0.75]
    ($(HIST)+(0.3,-0.1)$) rectangle ($(HIST)+(0.6, 0.75)$);
\fill[histcol, opacity=0.65]
    ($(HIST)+(0.6,-0.1)$) rectangle ($(HIST)+(0.9, 0.53)$);
\fill[histcol, opacity=0.55]
    ($(HIST)+(0.9,-0.1)$) rectangle ($(HIST)+(1.2, 0.45)$);
\fill[histcol, opacity=0.48]
    ($(HIST)+(1.2,-0.1)$) rectangle ($(HIST)+(1.5, 0.38)$);
\fill[histcol, opacity=0.43]
    ($(HIST)+(1.5,-0.1)$) rectangle ($(HIST)+(1.8, 0.32)$);
\fill[histcol, opacity=0.40]
    ($(HIST)+(1.8,-0.1)$) rectangle ($(HIST)+(2.1, 0.25)$);
\fill[histcol, opacity=0.38]
    ($(HIST)+(2.1,-0.1)$) rectangle ($(HIST)+(2.4, 0.18)$);
\fill[histcol, opacity=0.36]
    ($(HIST)+(2.4,-0.1)$) rectangle ($(HIST)+(2.7, 0.12)$);
\fill[histcol, opacity=0.35]
    ($(HIST)+(2.7,-0.1)$) rectangle ($(HIST)+(3.0, 0.07)$);
\fill[histcol, opacity=0.35]
...
\node[text=labelcol, font=\small, align=center] at (8.0, 0.55)
    {$g^{(2)}(\tau,B) = H(t_1-t_2)\,/\,H_{\text{uncorr}}$ \quad peak $\propto \left|\mathrm{sinc}\!\left(\tfrac{\pi B\theta_s}{\lambda}\right)\right|^2$ encodes $\theta_s$};
