...
% ════════════════════════════════════════════════════════
\coordinate (REC1) at (9.35, 5.5);
\coordinate (REC2) at (9.35, 3.5);
...
\node[text=labelcol, font=\small, align=center] at (8.0, 0.55)
    {$g^{(2)}(\tau,B) = [H(\tau) - \langle H \rangle]\,/\,\langle H \rangle$ \quad peak $\propto \left|\mathrm{sinc}\!\left(\tfrac{\pi B\theta_s}{\lambda}\right)\right|^2$ encodes $\theta_s$};
