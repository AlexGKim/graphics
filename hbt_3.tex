...
% Histogram bars for τ>=0 (lower peak due to spatial coherence at baseline B, faster decay)
\fill[histcol, opacity=0.8]
    ($(HIST)+(0.0,-0.1)$) rectangle ($(HIST)+(0.3, 1.15)$);
\fill[histcol, opacity=0.75]
    ($(HIST)+(0.3,-0.1)$) rectangle ($(HIST)+(0.6, 0.85)$);
\fill[histcol, opacity=0.65]
    ($(HIST)+(0.6,-0.1)$) rectangle ($(HIST)+(0.9, 0.72)$);
\fill[histcol, opacity=0.55]
    ($(HIST)+(0.9,-0.1)$) rectangle ($(HIST)+(1.2, 0.65)$);
\fill[histcol, opacity=0.48]
    ($(HIST)+(1.2,-0.1)$) rectangle ($(HIST)+(1.5, 0.60)$);
\fill[histcol, opacity=0.43]
    ($(HIST)+(1.5,-0.1)$) rectangle ($(HIST)+(1.8, 0.57)$);
\fill[histcol, opacity=0.40]
    ($(HIST)+(1.8,-0.1)$) rectangle ($(HIST)+(2.1, 0.54)$);
\fill[histcol, opacity=0.38]
    ($(HIST)+(2.1,-0.1)$) rectangle ($(HIST)+(2.4, 0.52)$);
\fill[histcol, opacity=0.36]
    ($(HIST)+(2.4,-0.1)$) rectangle ($(HIST)+(2.7, 0.50)$);
\fill[histcol, opacity=0.35]
    ($(HIST)+(2.7,-0.1)$) rectangle ($(HIST)+(3.0, 0.50)$);
\fill[histcol, opacity=0.35]
    ($(HIST)+(3.0,-0.1)$) rectangle ($(HIST)+(3.3, 0.49)$);
\fill[histcol, opacity=0.35]
    ($(HIST)+(3.3,-0.1)$) rectangle ($(HIST)+(3.6, 0.49)$);
