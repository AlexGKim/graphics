...
\fill[histcol, opacity=0.75]
    ($(HIST)+(0.3,-0.1)$) rectangle ($(HIST)+(0.6, 0.90)$);
\fill[histcol, opacity=0.65]
    ($(HIST)+(0.6,-0.1)$) rectangle ($(HIST)+(0.9, 0.70)$);
\fill[histcol, opacity=0.55]
    ($(HIST)+(0.9,-0.1)$) rectangle ($(HIST)+(1.2, 0.60)$);
\fill[histcol, opacity=0.48]
    ($(HIST)+(1.2,-0.1)$) rectangle ($(HIST)+(1.5, 0.55)$);
\fill[histcol, opacity=0.43]
    ($(HIST)+(1.5,-0.1)$) rectangle ($(HIST)+(1.8, 0.52)$);
\fill[histcol, opacity=0.40]
    ($(HIST)+(1.8,-0.1)$) rectangle ($(HIST)+(2.1, 0.48)$);
\fill[histcol, opacity=0.38]
    ($(HIST)+(2.1,-0.1)$) rectangle ($(HIST)+(2.4, 0.35)$);
\fill[histcol, opacity=0.36]
    ($(HIST)+(2.4,-0.1)$) rectangle ($(HIST)+(2.7, 0.25)$);
\fill[histcol, opacity=0.35]
    ($(HIST)+(2.7,-0.1)$) rectangle ($(HIST)+(3.0, 0.15)$);
\fill[histcol, opacity=0.35]
    ($(HIST)+(3.0,-0.1)$) rectangle ($(HIST)+(3.3, 0.08)$);
\fill[histcol, opacity=0.35]
    ($(HIST)+(3.3,-0.1)$) rectangle ($(HIST)+(3.6, 0.04)$);
